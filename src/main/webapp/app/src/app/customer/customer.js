angular.module('ngBoilerplate.customer', ['ui.router', 'ngResource', 'hateoas', 'angular-growl'])
...
.controller("ManageCustomerCtrl", function($scope, customerService, $state, growl) {
    $scope.createCustomer = function() {
        customerService.createCustomer($scope.customer).then(
            function() {
                console.log('test');
                growl.addInfoMessage('test');
//                growl.addInfoMessage('Customer Created');
            },
            function() {
                console.log('test');
                growl.addInfoMessage('test');
//                growl.addErrorMessage('Customer could not be created');
            }
        );
    };
